...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li {{ request()->is('accountant/student_fee_manager*') || request()->is('accountant/offline_payment/pending*') || request()->is('accountant/expense_category*') || request()->is('accountant/expenses*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('accountant/student_fee_manager*') ? 'active' : '' }}"
                            href="{{ route('accountant.fee_manager.list') }}"><span>
                                {{ get_phrase('Student Fee Manager') }}
                            </span></a></li>
                    <li><a class="{{ request()->is('accountant/offline_payment/pending*') ? 'active' : '' }}"
                            href="{{ route('accountant.offline_payment_pending') }}"><span>
                                {{ get_phrase('Offline Payment Request') }}
                            </span></a></li>
                    <li><a class="{{ request()->is('accountant/expenses*') ? 'active' : '' }}"
                            href="{{ route('accountant.expense.list') }}"><span>
                                {{ get_phrase('Expense Manager') }}
                            </span></a></li>
                    <li><a class="{{ request()->is('accountant/expense_category*') ? 'active' : '' }}"
                            href="{{ route('accountant.expense.category_list') }}"><span>
            ...
            <li
                class="nav-links-li {{ request()->is('accountant/noticeboard*') || request()->is('accountant/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('accountant/noticeboard*') ? 'active' : '' }}"
                            href="{{ route('accountant.noticeboard.list') }}">
                            <span>{{ get_phrase('Noticeboard') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('accountant/events/list*') ? 'active' : '' }}"
                            href="{{ route('accountant.events.list') }}">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('accountant.password', ['edit']) }}">
                                                    <span>
