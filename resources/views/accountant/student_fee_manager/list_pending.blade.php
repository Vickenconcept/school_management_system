...
<div class="table-responsive tScrollFix pb-2">
    <table id="student_fee" class="table eTable">
        <thead>
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="adminTable-action">
                            ...
                            >
                              <li>
                                <a class="dropdown-item" href="{{ route('accountant.studentFeeinvoice', ['id'=>$invoice['id']]) }}" target="_blank">{{ get_phrase('Print invoice') }}</a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('accountant.update_offline_payment', ['id' => $invoice->id,'status'=>'approve']) }}', 'undefined');">{{ get_phrase('Approve') }}</a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('accountant.update_offline_payment', ['id' => $invoice->id,'status'=>'decline']) }}', 'undefined');">{{ get_phrase('Decline') }}</a>
                              </li>
                            </ul>
                        </div>
                    </td>
            ...
            @foreach($invoices as $invoice)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small>{{ $student_details['section_name'] }}
                    </td>
                    <td>
                        {{ $invoice['title'] }}
                    </td>
