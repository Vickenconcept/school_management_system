...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li {{ request()->is('teacher/attendance*') || request()->is('teacher/routine') || request()->is('teacher/subject') || request()->is('teacher/gradebook') || request()->is('teacher/syllabus') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('teacher/attendance*') ? 'active' : '' }}"
                            href="{{ route('teacher.daily_attendance') }}"><span>{{ get_phrase('Daily Attendance') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('teacher/routine') ? 'active' : '' }}"
                            href="{{ route('teacher.routine') }}"><span>{{ get_phrase('Class Routine') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('teacher/subject') ? 'active' : '' }}"
                            href="{{ route('teacher.subject_list') }}"><span>{{ get_phrase('Subjects') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('teacher/gradebook') ? 'active' : '' }}"
                            href="{{ route('teacher.gradebook') }}"><span>{{ get_phrase('Gradebooks') }}</span></a>
                    </li>
                    <li>
                        <a class="{{ request()->is('teacher/syllabus') ? 'active' : '' }}"
                            href="{{ route('teacher.list_of_syllabus') }}"><span>{{ get_phrase('Syllabus') }}</span></a>
                    </li>
                </ul>
            </li>

            <li
                class="nav-links-li {{ request()->is('teacher/marks') || request()->is('teacher/offline_exam') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('teacher/marks') ? 'active' : '' }}"
                            href="{{ route('teacher.marks') }}"><span>{{ get_phrase('Marks') }}</span></a>
                    </li>
                    <li>
                        <a class="{{ request()->is('teacher/offline_exam') ? 'active' : '' }}"
                            href="{{ route('teacher.offline_exam') }}"><span>{{ get_phrase('Exam List') }}</span></a>
                    </li>
                </ul>
            </li>
            ...
            @if (addon_status('online_live_class') == 1)
                <li
                    class="nav-links-li {{ request()->is('teacher/add_live_class*') || request()->is('teacher/list_of_live_class*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="{{ request()->is('teacher/add_live_class*') ? 'active' : '' }}"
                                href="{{ route('teacher.add_live_class') }}">
                                <span>{{ get_phrase('Add new ') }}</span>
                                <!-- <span class="badge bg-success m-1" style="">{{ get_phrase('Addon') }}</span> -->
                            </a>
                        </li>
                        <li>
                            <a class="{{ request()->is('teacher/list_of_live_class*') ? 'active' : '' }}"
                                href="{{ route('teacher.list_of_live_class') }}">
            ...
            @if (addon_status('online_courses') == 1)
                <li class="nav-links-li {{ request()->is('teacher/addons/courses*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a class="{{ request()->is('teacher/addons/courses*') ? 'active' : '' }}"
                            href="{{ route('teacher.addons.courses') }}">
                            <div class="sidebar_icon">
            ...
            @if (addon_status('hr_management') == 1)
                ...
                <li
                    class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu' : '' }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="{{ request()->is('payment/list*') ? 'active' : '' }}"
                                href="{{ route('hr.user_list_of_payrolls') }}">
            ...
            <li
                class="nav-links-li {{ request()->is('teacher/noticeboard*') || request()->is('teacher/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('teacher/noticeboard*') ? 'active' : '' }}"
                            href="{{ route('teacher.noticeboard.list') }}">
                            <span>{{ get_phrase('Noticeboard') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('teacher/events/list*') ? 'active' : '' }}"
                            href="{{ route('teacher.events.list') }}">
