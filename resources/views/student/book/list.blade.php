    ...
    <div class="col-12">
        <div class="eSection-wrap pb-2">
        	<div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
		        <form action="{{ route('student.book.book_list') }}">
			        <div
...
<div class="table-responsive book_list display-none-view" id="book_list">
	<h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;">{{ get_phrase('Book List') }}</h4>
	<table id="basic-datatable" class="table eTable">
        <thead>
            <tr>
            	<th>#</th>
