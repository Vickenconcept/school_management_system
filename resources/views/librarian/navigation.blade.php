...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <!-- Sidebar menu -->
            <li
                class="nav-links-li {{ request()->is('librarian/book*') || request()->is('librarian/book_issue*') || request()->is('librarian/noticeboard*') || request()->is('librarian/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('librarian/book/list') ? 'active' : '' }}"
                            href="{{ route('librarian.book.book_list') }}">
                            <span>{{ get_phrase('Book List Manager') }}</span>
                        </a>
                    </li>

                    <li>
                        <a class="{{ request()->is('librarian/book_issue') ? 'active' : '' }}"
                            href="{{ route('librarian.book_issue.list') }}">
                            <span>{{ get_phrase('Book Issue Report') }}</span>
                        </a>
                    </li>

                    <li>
                        <a class="{{ request()->is('librarian/noticeboard*') ? 'active' : '' }}"
                            href="{{ route('librarian.noticeboard.list') }}">
                            <span>{{ get_phrase('Noticeboard') }}</span>
                        </a>
                    </li>

                    <li>
                        <a class="{{ request()->is('librarian/events/list*') ? 'active' : '' }}"
                            href="{{ route('librarian.events.list') }}">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('librarian.password', ['edit']) }}">
                                                    <span>
