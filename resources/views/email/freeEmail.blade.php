...
use App\Models\Subscription;
    ...
    $school_name = School::find($status->school_id);
            ...
            <tbody>
                                ...
                                <div class="feature-item" style="margin-top:30px; ">
                                     ...
                                     <div style="display: flex; align-items: center; ">
                                         <div style="margin-right: 350px;">
                                            ...
                                            <p style="font-size: 15px; color: #7B7F84; margin: 0; margin-top: 6px;">{{ date('d-M-Y', $status['expire_date']) }}</p>
                                        </div>
                                        <div>
                    ...
                    <td>
                        <table style="border:1px solid #E4E7EC; margin-top: 15px;" cellpadding="20" cellspacing="0" width="600" id="emailContainer">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding: 16px 0 ; border-bottom: 1px solid #E4E7EC;">
                                    <p style="margin: 0; font-size: 15px; color: #7B7F84;">{{ $status['paid_amount'] }}</p>
                                </td>
                                <td style="text-align: center; padding: 16px  0; border-bottom: 1px solid #E4E7EC;">
                                    <p style="margin: 0; font-size: 15px; color: #7B7F84;">{{ $status['paid_amount'] }}</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding: 16px 0 ;">
                                    <p style="margin: 0; font-size: 16px; font-weight: 500; color: #007BFF;">{{ $status['paid_amount'] }}</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr style="text-align: center;">
                    <td>
                        ...
                        <p style="font-size: 15px; color: #7B7F84; margin: 0; margin-top: 6px;">{{ $status['payment_method'] }}</p>
