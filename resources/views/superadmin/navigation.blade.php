...
<body>
    ...
    <div class="sidebar print-hidden">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li {{ request()->is('superadmin/subscription/report*') || request()->is('superadmin/subscription/expired_subcription*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('superadmin/subscription/report*') ? 'active' : '' }}"
                            href="{{ route('superadmin.subscription.report') }}"><span>{{ get_phrase('Subscription Report') }}</span></a>
                    </li>

                    <li><a class="{{ request()->is('superadmin/subscription/expired_subcription*') ? 'active' : '' }}"
                            href="{{ route('superadmin.subscription.expired_subcription') }}"><span>{{ get_phrase('Expired Subscription') }}</span></a>
                    </li>
            ...
            <li class="nav-links-li {{ request()->is('superadmin/package*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a class="{{ request()->is('superadmin/package*') ? 'active' : '' }}"
                        href="{{ route('superadmin.package') }}">
                        <div class="sidebar_icon">
            ...
            <li class="nav-links-li {{ request()->is('superadmin/addon/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a class="{{ request()->is('superadmin/addon/list*') ? 'active' : '' }}"
                        href="{{ route('superadmin.addon.list') }}">
                        <div class="sidebar_icon">
            ...
            <li
                class="nav-links-li {{ request()->is('superadmin/settings/system*') || request()->is('superadmin/settings/website*') || request()->is('superadmin/settings/faq*') || request()->is('superadmin/payment/settings*') || request()->is('superadmin/settings/language*') || request()->is('superadmin/settings/smtp*') || request()->is('superadmin/settings/about*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('superadmin/settings/system*') ? 'active' : '' }}"
                            href="{{ route('superadmin.system_settings') }}"><span>{{ get_phrase('System Settings') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/settings/website*') ? 'active' : '' }}"
                            href="{{ route('superadmin.website_settings') }}"><span>{{ get_phrase('Website Settings') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/settings/faq*') ? 'active' : '' }}"
                            href="{{ route('superadmin.faq_views') }}"><span>{{ get_phrase('Manage Faq') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/payment/settings*') ? 'active' : '' }}"
                            href="{{ route('superadmin.payment_settings') }}"><span>{{ get_phrase('Payment Settings') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/settings/language*') ? 'active' : '' }}"
                            href="{{ route('superadmin.language.manage') }}"><span>{{ get_phrase('Language Settings') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/settings/smtp*') ? 'active' : '' }}"
                            href="{{ route('superadmin.smtp_settings') }}"><span>{{ get_phrase('Smtp settings') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('superadmin/settings/about*') ? 'active' : '' }}"
                            href="{{ route('superadmin.about') }}"><span>{{ get_phrase('About') }}</span></a></li>
                </ul>
            </li>
        </ul>
    </div>
                ...
                <div class="row w-100 justify-content-between align-items-center">
                    ...
                    @if (get_settings('frontend_view') == '1')
                        <div class="col float-left">
                            <div class="sidebar_menu_icon">
                                <a href="{{ route('landingPage') }}" target=""
                                ...
                                <li class="user-profile">
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            aria-expanded="false">
                                            <div class="">
                                                <img src="{{ $user_image }}" height="42px" />
                                            </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li class="user-profile user-profile-inner">
                                                <button class="btn w-100 d-flex align-items-center" type="button">
                                                    <div class="">
                                                        <img class="radious-5px" src="{{ $user_image }}"
                                                            height="42px" />
                                                    </div>
                                                    <div class="px-2 text-start">
                                                        <span class="user-name">{{ auth()->user()->name }}</span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.password', ['edit']) }}">
                                                    <span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.system_settings') }}">
                                                    <span>
