...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li {{ request()->is('parent/teacherlist*') || request()->is('parent/childlist*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('parent/teacherlist*') ? 'active' : '' }}"
                            href="{{ route('parent.teacherlist') }}"><span>{{ get_phrase('Teacher') }}</span></a></li>
                    <li><a class="{{ request()->is('parent/childlist*') ? 'active' : '' }}"
                            href="{{ route('parent.childlist') }}"><span>{{ get_phrase('Child') }}</span></a></li>
                </ul>
            </li>

            <li
                class="nav-links-li {{ request()->is('parent/attendence/list*') || request()->is('parent/routine*') || request()->is('parent/child/syllabus*') || request()->is('parent/child/subjects*') || request()->is('student/syllabus*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="{{ request()->is('parent/attendence/list*') ? 'active' : '' }}"
                            href="{{ route('parent.list_of_attendence') }}"><span>{{ get_phrase('Daily Attendance') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('parent/routine*') ? 'active' : '' }}"
                            href="{{ route('parent.routine') }}"><span>{{ get_phrase('Class Routine') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('parent/child/subjects*') ? 'active' : '' }}"
                            href="{{ route('parent.subject_list') }}"><span>{{ get_phrase('Subjects') }}</span></a>
                    </li>
                    <li><a class="{{ request()->is('parent/child/syllabus*') ? 'active' : '' }}"
                            href="{{ route('parent.syllabus_list') }}"><span>{{ get_phrase('Syllabus') }}</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li
                class="nav-links-li {{ request()->is('parent/marks') || request()->is('parent/grade') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('parent/marks') ? 'active' : '' }}"
                            href="{{ route('parent.marks') }}"><span>{{ get_phrase('Marks') }}</span></a>
                    </li>
                    <li>
                        <a class="{{ request()->is('parent/grade') ? 'active' : '' }}"
                            href="{{ route('parent.grade_list') }}"><span>{{ get_phrase('Grades') }}</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-links-li {{ request()->is('parent/fee_manager*') ? 'showMenu' : '' }}">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('parent/fee_manager*') ? 'active' : '' }}"
                            href="{{ route('parent.fee_manager.list') }}">
            ...
            <li
                class="nav-links-li {{ request()->is('parent/noticeboard*') || request()->is('parent/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('parent/noticeboard*') ? 'active' : '' }}"
                            href="{{ route('parent.noticeboard.list') }}">
                            <span>{{ get_phrase('Noticeboard') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('parent/events/list*') ? 'active' : '' }}"
                            href="{{ route('parent.events.list') }}">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li class="user-profile user-profile-inner">
                                                <button class="btn w-100 d-flex align-items-center" type="button">
                                                    <div class="">
                                                        <img class="radious-5px" src=" {{ $user_image }}" height="42px" />
                                                    </div>
                                                    <div class="px-2 text-start">
                                                        <span class="user-name">{{ auth()->user()->name }}</span>
                                                        <span class="user-title">{{ get_phrase('Parent') }}</span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('parent.password', ['edit']) }}">
                                                    <span>
