...
<div class="row">
    <div class="col-12">
      <div class="eSection-wrap-2">
        ...
        <!-- Attendance banner -->
        @if(count($attendance_of_students) > 0)
        <div class="att-report-banner d-flex justify-content-center justify-content-md-between align-items-center flex-wrap" id="pdf_table">
        ...
        <div class="att-table" id="pdf_table">
          <div class="att-title" id="pdf_table">
             <h4 class="att-title-header"> {{ ucfirst('Student') }} /  {{ get_phrase('Date') }}</h4>
            <ul class="att-stuName-items">
              <?php foreach($students_details as $attendance_of_student ):  ?>
                <?php  
                $user_details = (new CommonController)->get_student_details_by_id($attendance_of_student['user_id'])->toArray();  
