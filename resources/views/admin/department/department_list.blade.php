            ...
            <div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
              ...
              <div class="position-relative">
                ...
                >
                  ...
                  <li>
                      <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('department_list')">{{ get_phrase('Print') }}</a>
                  </li>
                </ul>
              </div>
              @endif
...
<div class="table-responsive department_list display-none-view" id="department_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:7%; margin-bottom:15px; margin-top:17px;">{{ get_phrase('Department List') }}</h4> 
    <table class="table eTable">
        <thead>
            <tr>
                <th>#</th>
