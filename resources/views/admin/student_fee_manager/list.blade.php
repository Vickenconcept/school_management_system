                    ...
                    <td>
                        <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="largeModal('{{ route('admin.payment_settings.check_payment', ['id' => $invoice->id]) }}','{{ get_phrase('Check Payment') }}')">{{ get_phrase('Check Payment') }} </a>
                              </li>
                            </ul>
                        </div>
                    </td>
