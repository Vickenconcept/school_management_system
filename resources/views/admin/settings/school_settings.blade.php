                                ...
                                <div class="row mt-4">
                                    <div class="col-md-4 text-center ">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            <img src="{{ DB::table('schools')->where('id', auth()->user()->school_id)->value('school_logo')  }}" class="mx-4 my-5" width="80px" height="80px"
                                                alt="...">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            ...
                                            <img src="{{ DB::table('schools')->where('id', auth()->user()->school_id)->value('socialLogo1') }}" class="mx-4 my-5" width="80px" height="80px"
                                                alt="...">
                                            <div class="eCard-body">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            <img src="{{ DB::table('schools')->where('id', auth()->user()->school_id)->value('socialLogo2') }}" class="mx-4 my-5" width="80px" height="80px"
                                                alt="...">
                                            <div class="eCard-body">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                             <img src="{{ DB::table('schools')->where('id', auth()->user()->school_id)->value('socialLogo3') }}" class="mx-4 my-5" width="80px" height="80px"
                                                alt="...">
                                            <div class="eCard-body">
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            ...
                                            <img src="{{ DB::table('schools')->where('id', auth()->user()->school_id)->value('email_logo') }}" class="mx-4 my-5" width="80px" height="80px"
                                                alt="...">
                                            <div class="eCard-body">
