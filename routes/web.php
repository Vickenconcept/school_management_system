...
Route::controller(AdminController::class)->middleware('admin','auth')->group(function () {
    ...
    Route::post('admin/subscription/offline/payment', function(){
           ...
           $pending_payment['package_id']=1;
           $pending_payment['amount']='10';
           $pending_payment['school_id']=auth()->user()->school_id;
           $pending_payment['transaction_keys']='[]';
           $pending_payment['document_image']='image';
    ...
    })->name('admin.admin_subscription_offline_payment');
    ...
    Route::get('admin/check_payment/{id}', 'check_payment')->name('admin.payment_settings.check_payment');
