...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Teacher') . ' | ' . get_settings('system_title')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <!-- sidebar title -->
            <li class="nav-links-li <?php echo e(request()->is('teacher/dashboard') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('teacher/attendance*') || request()->is('teacher/routine') || request()->is('teacher/subject') || request()->is('teacher/gradebook') || request()->is('teacher/syllabus') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('teacher/attendance*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.daily_attendance')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('teacher/routine') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('teacher/subject') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('teacher/gradebook') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.gradebook')); ?>"><span><?php echo e(get_phrase('Gradebooks')); ?></span></a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('teacher/syllabus') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.list_of_syllabus')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a>
                    </li>
                </ul>
            </li>

            <li
                class="nav-links-li <?php echo e(request()->is('teacher/marks') || request()->is('teacher/offline_exam') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('teacher/marks') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('teacher/offline_exam') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.offline_exam')); ?>"><span><?php echo e(get_phrase('Exam List')); ?></span></a>
                    </li>
                </ul>
            </li>


            <?php if(addon_status('online_live_class') == 1): ?>
                <li
                    class="nav-links-li <?php echo e(request()->is('teacher/add_live_class*') || request()->is('teacher/list_of_live_class*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                            ...
                            <span class="link_name"><?php echo e(get_phrase('Live class ')); ?></span>
                        </a>
                        <span class="arrow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="4.743" height="7.773"
                                viewBox="0 0 4.743 7.773">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="<?php echo e(request()->is('teacher/add_live_class*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('teacher.add_live_class')); ?>">
                                <span><?php echo e(get_phrase('Add new ')); ?></span>
                                <!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(request()->is('teacher/list_of_live_class*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('teacher.list_of_live_class')); ?>">
                                <span><?php echo e(get_phrase('Live Classes ')); ?></span>
                                <!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                            </a>
                        </li>
            ...
            <?php if(addon_status('online_courses') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('teacher/addons/courses*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a class="<?php echo e(request()->is('teacher/addons/courses*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.addons.courses')); ?>">
                            <div class="sidebar_icon">
                            ...
                            <span class="link_name">
                                <?php echo e(get_phrase('Online Course')); ?>
            ...
            <?php if(addon_status('hr_management') == 1): ?>
                ...
                <li
                    class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu' : ''); ?>">
                    ...
                    <div class="iocn-link">
                        <a href="#">
                            ...
                            <span class="link_name"><?php echo e(get_phrase('Human Resource')); ?></span>
                        </a>
                        <span class="arrow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="4.743" height="7.773"
                                viewBox="0 0 4.743 7.773">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="<?php echo e(request()->is('attendence/list*') ? 'active' : ''); ?>"
                                ...
                                <span><?php echo e(get_phrase('Attendence Report')); ?></span>
                                <!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('hr/leave_list*') ? 'active' : ''); ?>"
                                ...
                                <span><?php echo e(get_phrase('Leave')); ?></span>
                                <!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                            </a>
                        </li>
                        <li>
                            <a class="<?php echo e(request()->is('payment/list*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.user_list_of_payrolls')); ?>">
                                <span><?php echo e(get_phrase('Payroll')); ?></span>
                                <!-- <span class="badge bg-success m-1" style=""><?php echo e(get_phrase('Addon')); ?></span> -->
                            </a>
                        </li>
            ...
            <?php if(addon_status('assignments') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('teacher/assignments*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="<?php echo e(route('teacher.assignment_home', ['type' => 'published'])); ?>">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('teacher/noticeboard*') || request()->is('teacher/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('teacher/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.noticeboard.list')); ?>">
                            <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('teacher/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('teacher.events.list')); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('teacher/profile*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                                    ...
                                    <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a class="dropdown-item language-item" href="javascript:;"
                                                data-language-name="<?php echo e($all_language->name); ?>"><?php echo e(ucwords($all_language->name)); ?></a>
                                        </li>
                                ...
                                <li class="user-profile">
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            aria-expanded="false">
                                            <div class="">
                                                <img src="<?php echo e($user_image); ?>" height="42px" />
                                            </div>
                                            <div class="px-2 text-start">
                                                <span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                                                <span class="user-title"><?php echo e(get_phrase('Teacher')); ?></span>
                                            </div>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li class="user-profile user-profile-inner">
                                                <button class="btn w-100 d-flex align-items-center" type="button">
                                                    <div class="">
                                                        <img class="radious-5px" src="<?php echo e($user_image); ?>"
                                                            height="42px" />
                                                    </div>
                                                    <div class="px-2 text-start">
                                                        <span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('teacher.profile')); ?>">
                                                    <span>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/teacher/navigation.blade.php ENDPATH**/ ?>