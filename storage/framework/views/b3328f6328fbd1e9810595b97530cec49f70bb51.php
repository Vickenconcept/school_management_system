...
?>
    ...
    <div class="user-profile-area d-flex flex-wrap">
        ...
        <div class="user-info d-flex flex-column">
            ...
            <div class="userImg">
                <img width="100%" src="<?php echo e($user_image); ?>" alt="" />
            </div>
            <div class="userContent text-center">
                <h4 class="title"><?php echo e(auth()->user()->name); ?></h4>
                <p class="info"><?php echo e(get_phrase('Librarian')); ?></p>
        ...
        <div class="user-details-info">
            ...
            >
                ...
                <form action="<?php echo e(route('librarian.profile.update')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('librarian.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/librarian/profile/view.blade.php ENDPATH**/ ?>