                     ...
                     <div class="dashboard_ShortListItem">
                       ...
                       >
                         ...
                         <div class="ds_item_icon">
                           <img
                             src="<?php echo e(asset('../assets/images/Student_icon.png')); ?>"
                             alt=""
                           />
                         </div>
                       </div>
                   ...
                   <div class="col-md-6">
                     <div class="dashboard_ShortListItem">
                       ...
                       >
                         ...
                         <a href="<?php echo e(route('parent.teacherlist')); ?>" class="ds_link ds_teacher">
                           <svg
             ...
             <div class="col-md-6 ms-auto">
               <div class="dashboard_report dashboard_upcoming_events">
                 ...
                 <div class="ds_report_list pt-38">
                   ...
                   <div class="text-end">
                     <a href="<?php echo e(route('parent.events.list')); ?>" class="all_report_btn_2"><?php echo e(get_phrase('See all')); ?></a>
                   </div>
                 </div>
               </div>
             </div>
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/parent/dashboard.blade.php ENDPATH**/ ?>