        ...
        <ul class="nav-links">
            ...
            <li
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a class="<?php echo e(request()->is('admin/grade') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.grade_list')); ?>"><span><?php echo e(get_phrase('Grades')); ?></span></a>
                    </li>
                    <li>
                        ...
                        <div class="header_notification d-flex align-items-center">
                            <div class="notification_icon">
                                ...
                                <?php if(!empty($school_data->school_logo)): ?>
                                    <img class=""
                                        src="<?php echo e(asset(DB::table('schools')->where('id', auth()->user()->school_id)->value('school_logo'))); ?>"
                                        width="30px" height="30px" style="border-radius: 50%; ">
                                <?php else: ?>
                                    <img class="" src="images/id_logo.png"
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/navigation.blade.php ENDPATH**/ ?>