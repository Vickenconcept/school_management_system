 ...
 <link rel="stylesheet" href="<?php echo e(asset('../assets/css/daterangepicker.css')); ?>" />
  ...
  <body>
    ...
    <div class="main_content paymentContent">
      ...
      >
        <h5 class="title"><?php echo e(get_phrase('Make Payment')); ?> </h5>
        <button
          type="button"
          class="btn-close"
          data-bs-dismiss="modal"
          aria-label="Close"
          onclick="location.href='<?php echo e(redirect()->back()->getTargetUrl()); ?>'"
        ></button>
      </div>
      ...
      <div class="paymentWrap d-flex align-items-start flex-wrap">
        <div class="paymentLeft">
          ...
          <p class="payment_tab_title pb-30"><?php echo e(get_phrase('Payment Gateway')); ?> </p>
          <!-- Tab -->
          <div
          ...
          >
                    ...
                    <div
                    class="tabItem "
                    id="v-pills-<?php echo e($value['name']); ?>-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#v-pills-<?php echo e($value['name']); ?>"
                    role="tab"
                    aria-controls="v-pills-<?php echo e($value['name']); ?>"
                    aria-selected="true"
                >
        ...
        <div class="paymentRight">
          <p class="payment_tab_title pb-30">  <?php echo e(get_phrase('Invoice Summary')); ?></p>
              ...
              <table class="table eTable eTable-2">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="dAdmin_info_name min-w-100px">
                        <p> <?php echo e($fee_details['title']); ?></p>
                      </div>
                    </td>
                    <td>
                      <div class="dAdmin_info_name min-w-150px text-end">
                        <p>   <?php echo e($fee_details['total_amount']." ".get_active_currency()); ?> </p>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="dAdmin_info_name min-w-150px text-end">
                        <p><span><?php echo e(get_phrase('Grand Total')); ?> : <?php echo e($fee_details['total_amount']." ".get_active_currency()); ?></span></p>
                      </div>
                    </td>
                  </tr>
                </tbody>
          ...
          <div class="tab-content payment_modalTab_content" id="v-pills-tabContent" >
            ...
            <?php if(addon_status('payment_gateways')==1): ?>
                <?php echo $__env->make('parent.payment.paypal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('parent.payment.stripe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('parent.payment.razorpay', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('parent.payment.paytm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('parent.payment.flutterwave', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            ...
            <div class="tab-pane fade <?=$off?>" id="v-pills-offline" role="tabpanel" aria-labelledby="v-pills-offline-tab" tabindex="0">
              <div class="off_payment_form">
                ...
                <form action="<?php echo e(route('parent.offline_payment', ['id' => $fee_details['id']])); ?>" class="offline-form form" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                      <p > <?php echo e(get_phrase('Document of your payment')); ?></p>
                      <p class="eForm-label"> <?php echo e(get_phrase('Bank Name:')); ?>  <b> <?php echo e($school->bank_name); ?> </b></p>
                      <p class="eForm-label"> <?php echo e(get_phrase('Account Name:')); ?> <b> <?php echo e($school->account_name); ?> </b></p>
                      <p class="eForm-label"><?php echo e(get_phrase('Account Number:')); ?> <b> <?php echo e($school->account_number); ?> </b></p>
                    </div>
                    <br>

                    <div class="payable_document">
                        <label for="payableDocuemnt" class="eForm-label">
                        <?php echo e(get_phrase('Document of your payment')); ?> (jpg, pdf, png )
                    </label>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/parent/payment/payment_gateway.blade.php ENDPATH**/ ?>