...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Accountant') . ' | ' . get_settings('system_title')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <!-- sidebar title -->
            <li class="nav-links-li <?php echo e(request()->is('accountant/dashboard') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('accountant.dashboard')); ?>">
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('accountant/student_fee_manager*') || request()->is('accountant/offline_payment/pending*') || request()->is('accountant/expense_category*') || request()->is('accountant/expenses*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('accountant/student_fee_manager*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.fee_manager.list')); ?>"><span>
                                <?php echo e(get_phrase('Student Fee Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('accountant/offline_payment/pending*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.offline_payment_pending')); ?>"><span>
                                <?php echo e(get_phrase('Offline Payment Request')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('accountant/expenses*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.expense.list')); ?>"><span>
                                <?php echo e(get_phrase('Expense Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('accountant/expense_category*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.expense.category_list')); ?>"><span>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="<?php echo e(request()->is('attendence/list*') ? 'active' : ''); ?>"
                                ...
                                <span>
                                    <?php echo e(get_phrase('Attendence Report')); ?>
            ...
            <?php if(addon_status('inventory_manager') == 1): ?>
                <li
                    class="nav-links-li <?php echo e(request()->is('accountant/inventory/list') || request()->is('accountant/category/list') || request()->is('accountant/buy_sell_inventory*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('accountant/inventory/list') ? 'active' : ''); ?>"
                                href="<?php echo e(route('accountant.inventory.list')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('accountant/category/list') ? 'active' : ''); ?>"
                                href="<?php echo e(route('accountant.category.list')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('accountant/buy_sell_inventory') ? 'active' : ''); ?>"
                                href="<?php echo e(route('accountant.buy_sell_inventory')); ?>">
                                <span>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('accountant/noticeboard*') || request()->is('accountant/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('accountant/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.noticeboard.list')); ?>">
                            <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('accountant/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('accountant.events.list')); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('accountant/profile*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('accountant.profile')); ?>">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                                style="enable-background:new 0 0 512 512;" xml:space="preserve" width="48"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <div class="px-2 text-start">
                                                ...
                                                <span class="user-title"><?php echo e(get_phrase('Accountant')); ?></span>
                                            </div>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('accountant.profile')); ?>">
                                                    <span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('accountant.password', ['edit'])); ?>">
                                                    <span>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/accountant/navigation.blade.php ENDPATH**/ ?>