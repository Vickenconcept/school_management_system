...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../assets/css/lightbox.css')); ?>">
    <!---Icon Piker -->

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../assets/css/fontawesome-all.min.css')); ?>">

    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('../assets/css/font-awesome-icon-picker/fontawesome-iconpicker.min.css')); ?>">
...
<body>
    ...
    <div class="sidebar print-hidden">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('superadmin/subscription/report*') || request()->is('superadmin/subscription/expired_subcription*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                        ...
                        <span class="link_name"><?php echo e(get_phrase('Subcription')); ?></span>
                    </a>
                    <span class="arrow">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('superadmin/subscription/report*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.subscription.report')); ?>"><span><?php echo e(get_phrase('Subscription Report')); ?></span></a>
                    </li>

                    <li><a class="<?php echo e(request()->is('superadmin/subscription/expired_subcription*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.subscription.expired_subcription')); ?>"><span><?php echo e(get_phrase('Expired Subscription')); ?></span></a>
                    </li>
            ...
            <li class="nav-links-li <?php echo e(request()->is('superadmin/package*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e(request()->is('superadmin/package*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('superadmin.package')); ?>">
                        <div class="sidebar_icon">
                            <svg id="Layer_1" height="48px" viewBox="0 0 24 24" width="48px"
            ...
            <li class="nav-links-li <?php echo e(request()->is('superadmin/addon/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e(request()->is('superadmin/addon/list*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('superadmin.addon.list')); ?>">
                        <div class="sidebar_icon">
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('superadmin/settings/system*') || request()->is('superadmin/settings/website*') || request()->is('superadmin/settings/faq*') || request()->is('superadmin/payment/settings*') || request()->is('superadmin/settings/language*') || request()->is('superadmin/settings/smtp*') || request()->is('superadmin/settings/about*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('superadmin/settings/system*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.system_settings')); ?>"><span><?php echo e(get_phrase('System Settings')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/settings/website*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.website_settings')); ?>"><span><?php echo e(get_phrase('Website Settings')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/settings/faq*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.faq_views')); ?>"><span><?php echo e(get_phrase('Manage Faq')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/payment/settings*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.payment_settings')); ?>"><span><?php echo e(get_phrase('Payment Settings')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/settings/language*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.language.manage')); ?>"><span><?php echo e(get_phrase('Language Settings')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/settings/smtp*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.smtp_settings')); ?>"><span><?php echo e(get_phrase('Smtp settings')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('superadmin/settings/about*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('superadmin.about')); ?>"><span><?php echo e(get_phrase('About')); ?></span></a></li>
                </ul>
            </li>
        </ul>
    </div>
                ...
                <div class="row w-100 justify-content-between align-items-center">
                    ...
                    <?php if(get_settings('frontend_view') == '1'): ?>
                        <div class="col float-left">
                            <div class="sidebar_menu_icon">
                                <a href="<?php echo e(route('landingPage')); ?>" target=""
                                    class="btn btn-outline-primary ml-3 d-none d-md-inline-block"><?php echo get_phrase('Visit Website'); ?></a>
                            </div>
                        </div>
                    <?php endif; ?>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('superadmin.password', ['edit'])); ?>">
                                                    <span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('superadmin.system_settings')); ?>">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                            id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                            xml:space="preserve" width="13.275" height="14.944">
                                                            <g>
                                                                <path
                                                                    d="M256,162.923c-51.405,0-93.077,41.672-93.077,93.077s41.672,93.077,93.077,93.077s93.077-41.672,93.077-93.077   C349.019,204.619,307.381,162.981,256,162.923z M256,285.077c-16.059,0-29.077-13.018-29.077-29.077s13.018-29.077,29.077-29.077   c16.059,0,29.077,13.018,29.077,29.077l0,0C285.066,272.054,272.054,285.066,256,285.077z" />
                                                                <path
    ...
    <!---Image Gallery--->
    <script src="<?php echo e(asset('../assets/js/lightbox-plus-jquery.js')); ?>"></script>

    <!--Toaster Script-->
    <script src="<?php echo e(asset('../assets/js/toastr.min.js')); ?>"></script>

    <!--Fontawsome Icon-Piker-->
    <script src="<?php echo e(asset('../assets/js/font-awesome-icon-picker/fontawesome-iconpicker.min.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/superadmin/navigation.blade.php ENDPATH**/ ?>