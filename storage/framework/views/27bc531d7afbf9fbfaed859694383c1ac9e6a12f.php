        ...
        <div class="eSection-wrap">
            <div class="eMain">
                <div class="row">
                    <div class="col-md-11 pb-3">
                        <div class="eForm-layouts">
                            <p class="column-title"><?php echo e(get_phrase('Email Template Settings')); ?></p>
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.system.update')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="fpb-7">
                                    <label for="system_title" class="eForm-label"><?php echo e(get_phrase('Email Title')); ?></label>
                                    <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('email_title')); ?>" id="email_title" name = "email_title" required>
                                </div> 
    
                                <div class="fpb-7">
                                    <label for="email_details" class="eForm-label"><?php echo e(get_phrase('Email Details')); ?></label>
                                    <textarea class="form-control eForm-control" id="email_details" name="email_details" rows="4"  maxlength="200"  required><?php echo e(get_settings('email_details')); ?></textarea>
                                    
                                    <small><?php echo get_phrase('Remaining characters is'); ?> <strong id="remaining_character">200</strong> </small>
                                </div>
    
                                <div class="fpb-7">
                                    <label for="warning_text" class="eForm-label"><?php echo e(get_phrase('Warning Text')); ?></label>
                                    <textarea class="form-control eForm-control" id="warning_text" name="warning_text" rows="3"  maxlength="150"  required><?php echo e(get_settings('warning_text')); ?></textarea>
    
                                    <small><?php echo get_phrase('Remaining characters is'); ?> <strong id="remaining_character_warning">150</strong> </small>
                                </div>
                            <div class="row mt-5">
                                <div class="col-md-4 text-center">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Email logo')); ?></label>
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('../assets/uploads/email_logo/'.get_settings('email_logo'))); ?>" class="mx-4 my-5" width="80px" height="80px"
                                            alt="...">
                                        <div class="eCard-body">
                                ...
                                <div class="col-md-4 text-center">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Social logo-1')); ?></label>
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('../assets/uploads/email_logo/'.get_settings('socialLogo1'))); ?>" class="mx-4 my-5" width="80px" height="80px"
                                            alt="...">
                                        <div class="eCard-body">
                                ...
                                <div class="col-md-4 text-center">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Social logo-2')); ?></label>
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('../assets/uploads/email_logo/'.get_settings('socialLogo2'))); ?>" class="mx-4 my-5" width="80px" height="80px"
                                            alt="...">
                                        <div class="eCard-body">
                                ...
                                <div class="col-md-4 text-center">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Social logo-3')); ?></label>
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('../assets/uploads/email_logo/'.get_settings('socialLogo3'))); ?>" class="mx-4 my-5" width="80px" height="80px"
                                            alt="...">
                                        <div class="eCard-body">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/superadmin/settings/system_settings.blade.php ENDPATH**/ ?>