<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.create')); ?>">
        <?php echo csrf_field(); ?> 
        <div class="form-row">
            <div class="fpb-7">
...
</script><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/admin/add_admin.blade.php ENDPATH**/ ?>