...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Parent') . ' | ' . get_settings('system_title')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <!-- sidebar title -->
            <li class="nav-links-li <?php echo e(request()->is('parent/dashboard') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('parent/teacherlist*') || request()->is('parent/childlist*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('parent/teacherlist*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.teacherlist')); ?>"><span><?php echo e(get_phrase('Teacher')); ?></span></a></li>
                    <li><a class="<?php echo e(request()->is('parent/childlist*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.childlist')); ?>"><span><?php echo e(get_phrase('Child')); ?></span></a></li>
                </ul>
            </li>

            <li
                class="nav-links-li <?php echo e(request()->is('parent/attendence/list*') || request()->is('parent/routine*') || request()->is('parent/child/syllabus*') || request()->is('parent/child/subjects*') || request()->is('student/syllabus*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('parent/attendence/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.list_of_attendence')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('parent/routine*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('parent/child/subjects*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('parent/child/syllabus*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.syllabus_list')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a>
                    </li>
                </ul>
            </li>

            <?php if(addon_status('transport') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('parent/trips/list*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="<?php echo e(route('parent.trips.list')); ?>">
                            ...
                            <span class="link_name"><?php echo e(get_phrase('Trips')); ?></span>
                        </a>
                    </div>
                </li>
            <?php endif; ?>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('parent/marks') || request()->is('parent/grade') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('parent/marks') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('parent/grade') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.grade_list')); ?>"><span><?php echo e(get_phrase('Grades')); ?></span></a>
                    </li>
                </ul>
            </li>


            <li class="nav-links-li <?php echo e(request()->is('parent/fee_manager*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('parent/fee_manager*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.fee_manager.list')); ?>">
                            <span><?php echo e(get_phrase('Fee Manager')); ?></span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('parent/noticeboard*') || request()->is('parent/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('parent/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.noticeboard.list')); ?>">
                            <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('parent/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parent.events.list')); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('parent/profile*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('parent.profile')); ?>">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                                style="enable-background:new 0 0 512 512;" xml:space="preserve" width="48"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <div class="px-2 text-start">
                                                ...
                                                <span class="user-title"><?php echo e(get_phrase('Parent')); ?></span>
                                            </div>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li class="user-profile user-profile-inner">
                                                <button class="btn w-100 d-flex align-items-center" type="button">
                                                    <div class="">
                                                        <img class="radious-5px" src=" <?php echo e($user_image); ?>" height="42px" />
                                                    </div>
                                                    <div class="px-2 text-start">
                                                        <span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                                                        <span class="user-title"><?php echo e(get_phrase('Parent')); ?></span>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('parent.profile')); ?>">
                                                    <span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('parent.password', ['edit'])); ?>">
                                                    <span>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/parent/navigation.blade.php ENDPATH**/ ?>