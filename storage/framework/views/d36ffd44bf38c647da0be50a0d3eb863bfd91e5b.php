            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#"><?php echo e(get_phrase('Teachers')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="row">
  <div class="col-10 offset-md-1">
    <div class="eSection-wrap pb-2">
        ...
        <form action="<?php echo e(route('student.teacher')); ?>">
          <div
    	...
    	<?php if(count($teachers) > 0): ?>
		    ...
		    <thead>
		        <tr>
		            ...
		            <th><?php echo e(get_phrase('Department')); ?></th>
		            <th><?php echo e(get_phrase('Designation')); ?></th>
		        </tr>
		    </thead>
		    <tbody>
		        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		            ...
		            <tr>
		            	<td scope="row"><p class="row-number"><?php echo e($teachers->firstItem() + $key); ?></p></td>
		                <td><strong><?php echo e($teacher['name']); ?></strong></td>
			...
			<?php echo $teachers->appends(request()->all())->links(); ?>
...
<div class="table-responsive teacher_list display-none-view" id="teacher_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Teachers List')); ?></h4>
	<table id="basic-datatable" class="table eTable">
	    <thead>
	        <tr>
	        	<th>#</th>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/student/teacher/teacher_list.blade.php ENDPATH**/ ?>