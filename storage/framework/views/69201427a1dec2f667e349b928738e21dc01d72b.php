                    ...
                    <td>
                        <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="largeModal('<?php echo e(route('admin.payment_settings.check_payment', ['id' => $invoice->id])); ?>','<?php echo e(get_phrase('Check Payment')); ?>')"><?php echo e(get_phrase('Check Payment')); ?> </a>
                              </li>
                            </ul>
                        </div>
                    </td>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/student_fee_manager/list.blade.php ENDPATH**/ ?>