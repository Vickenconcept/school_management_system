...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Librarian') . ' | ' . get_settings('system_title')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <!-- sidebar title -->
            <li class="nav-links-li <?php echo e(request()->is('librarian/dashboard') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('librarian.dashboard')); ?>">
            ...
            <!-- Sidebar menu -->
            <li
                class="nav-links-li <?php echo e(request()->is('librarian/book*') || request()->is('librarian/book_issue*') || request()->is('librarian/noticeboard*') || request()->is('librarian/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('librarian/book/list') ? 'active' : ''); ?>"
                            href="<?php echo e(route('librarian.book.book_list')); ?>">
                            <span><?php echo e(get_phrase('Book List Manager')); ?></span>
                        </a>
                    </li>

                    <li>
                        <a class="<?php echo e(request()->is('librarian/book_issue') ? 'active' : ''); ?>"
                            href="<?php echo e(route('librarian.book_issue.list')); ?>">
                            <span><?php echo e(get_phrase('Book Issue Report')); ?></span>
                        </a>
                    </li>

                    <li>
                        <a class="<?php echo e(request()->is('librarian/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('librarian.noticeboard.list')); ?>">
                            <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                        </a>
                    </li>

                    <li>
                        <a class="<?php echo e(request()->is('librarian/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('librarian.events.list')); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('librarian/profile*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('librarian.profile')); ?>">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                                style="enable-background:new 0 0 512 512;" xml:space="preserve" width="48"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <div class="px-2 text-start">
                                                ...
                                                <span class="user-title"><?php echo e(get_phrase('Librarian')); ?></span>
                                            </div>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('librarian.profile')); ?>">
                                                    <span>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('librarian.password', ['edit'])); ?>">
                                                    <span>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/librarian/navigation.blade.php ENDPATH**/ ?>