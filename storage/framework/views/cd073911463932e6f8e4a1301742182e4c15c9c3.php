...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Student') . ' | ' . get_settings('system_title')); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <!-- sidebar title -->
            <li class="nav-links-li <?php echo e(request()->is('student/dashboard') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
            ...
            <li class="nav-links-li <?php echo e(request()->is('student/teacher*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e(request()->is('student/teacher*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('student.teacher')); ?>">
                        <div class="sidebar_icon">
                        ...
                        <span class="link_name"><?php echo e(get_phrase('Teacher')); ?></span>
                    </a>
                </div>
            </li>

            <li
                class="nav-links-li <?php echo e(request()->is('student/attendance*') || request()->is('student/routine*') || request()->is('student/subject*') || request()->is('student/syllabus*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('student/attendance*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.daily_attendance')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/routine*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/subject*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/syllabus*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.syllabus')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a></li>
                </ul>
            </li>

            <li
                class="nav-links-li <?php echo e(request()->is('student/marks') || request()->is('student/grade') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('student/marks') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('student/grade') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.grade_list')); ?>"><span><?php echo e(get_phrase('Grades')); ?></span></a>
                    </li>
                </ul>
            </li>

            <?php if(addon_status('online_live_class') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('student/list_of_live_class*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="<?php echo e(route('student.list_of_live_class')); ?>">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                    viewBox="0 0 24 24" width="48" height="48">
                                    <path
            ...
            <?php if(addon_status('online_courses') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('student/addons/courses*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a class="<?php echo e(request()->is('student/courses*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.addons.courses')); ?>">
                            <div class="sidebar_icon">
            ...
            <?php if(addon_status('assignments') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('student/my-assignments*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="<?php echo e(route('student.assignment_home', ['type' => 'active'])); ?>">
                            <div class="sidebar_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="link_name"><?php echo e(get_phrase('My assignments')); ?></span>
                        </a>
                    </div>
                </li>
            <?php endif; ?>

            <li class="nav-links-li <?php echo e(request()->is('student/fee_manager*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e(request()->is('student/fee_manager*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('student.fee_manager.list')); ?>">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                viewBox="0 0 24 24" width="48" height="48">
                                <path
                        ...
                        <span class="link_name">
                            <?php echo e(get_phrase('Fee Manager')); ?>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('student/book*') || request()->is('student/book_issue*') || request()->is('student/noticeboard*') || request()->is('student/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('student/book/list') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.book.book_list')); ?>"><span><?php echo e(get_phrase('List Of Books')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/book_issue') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.book.issued_list')); ?>"><span><?php echo e(get_phrase('Issued Book')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.noticeboard.list')); ?>"><span><?php echo e(get_phrase('Noticeboard')); ?></span></a>
                    </li>
                    <li><a class="<?php echo e(request()->is('student/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('student.events.list')); ?>"><span><?php echo e(get_phrase('Events')); ?></span></a>
                    </li>
                </ul>
            </li>
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <div class="px-2 text-start">
                                                ...
                                                <span class="user-title"><?php echo e(get_phrase('Student')); ?></span>
                                            </div>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('student.password', ['edit'])); ?>">
                                                    <span>
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/student/navigation.blade.php ENDPATH**/ ?>