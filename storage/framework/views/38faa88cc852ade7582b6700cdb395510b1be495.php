<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm"
        ...
        <div class="row fmb-14 justify-content-between align-items-center">
            <label for="department_id" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Department')); ?></label>
            <div class="col-md-10" id = "section_content">
        ...
        <div class="row fmb-14 justify-content-between align-items-center">
            <label for="birthdatepicker" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Birthday')); ?><span
...
<?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/offline_admission/single_student_admission.blade.php ENDPATH**/ ?>