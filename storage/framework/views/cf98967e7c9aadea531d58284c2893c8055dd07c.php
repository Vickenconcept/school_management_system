                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              ...
                              <?php endif; ?>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="largeModal('<?php echo e(route('admin.admin.admin_profile', ['id' => $admin->id])); ?>','<?php echo e(get_phrase('Admin Profile')); ?>')"><?php echo e(get_phrase('Profile')); ?></a>
                              </li>
                            </ul>
                          </div>
                        </td>
...
<div class="table-responsive admin_list display-none-view" id="admin_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Admin List')); ?></h4>
  <table class="table eTable eTable-2">
    <thead>
      <tr>
        <th scope="col">#</th>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/admin/admin_list.blade.php ENDPATH**/ ?>