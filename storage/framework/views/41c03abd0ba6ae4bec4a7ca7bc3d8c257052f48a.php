    ...
    <div class="user-profile-area d-flex flex-wrap">
        ...
        <div class="user-info d-flex flex-column">
            <div class="user-info-basic d-flex flex-column justify-content-center">
                ...
                <div class="userImg">
                    <img width="100%" height="150px" src="<?php echo e($user_image); ?>" alt="" />
                </div>
                <div class="userContent text-center">
                    <h4 class="title"><?php echo e(auth()->user()->name); ?></h4>
                    <p class="info"><?php echo e(get_phrase('Parent')); ?></p>
            ...
            <div class="tab-content eNav-Tabs-content" id="myTabContent">
                <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                    <div class="eForm-layouts">
                        <form action="<?php echo e(route('parent.profile.update')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="text" class="form-control eForm-control" id="eInputName" name="name"
                                    value="<?php echo e(auth()->user()->name); ?>" placeholder="Your Name" aria-label="Your Name" />
                            </div>
                            <div class="fpb-7">
                                ...
                                <input type="email" class="form-control eForm-control" id="eInputEmail" name="email"
                                    value="<?php echo e(auth()->user()->email); ?>" placeholder="example@email.com"
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="text" class="form-control eForm-control" id="eInputDate"
                                    name="eDefaultDateRange" value="<?php echo e(date('m/d/Y', $birthday)); ?>" />
                            </div>
                            <div class="fpb-7">
                                ...
                                <select name="gender" class="form-select eForm-select eChoice-multiple-without-remove"
                                    ...
                                    <option value="Male"
                                        <?php strtolower(json_decode(auth()->user()->user_information, true)['gender']) == 'male' ? 'selected':''; ?>>
                                        <?php echo e(get_phrase('Male')); ?></option>
                                    <option value="Female"
                                        <?php strtolower(json_decode(auth()->user()->user_information, true)['gender']) == 'female' ? 'selected':''; ?>>
                                        <?php echo e(get_phrase('Female')); ?></option>
                                </select>
                            </div>
                            <div class="fpb-7">
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="text" class="form-control eForm-control" id="eInputAddress" name="address"
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="hidden" class="form-control" name="old_photo"
                                    value="<?php echo e(json_decode(auth()->user()->user_information, true)['photo']); ?>" />
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/parent/profile/view.blade.php ENDPATH**/ ?>