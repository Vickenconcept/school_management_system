                    ...
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" enctype="multipart/form-data" class="col-12 live-class-settings-form" action="<?php echo e(route('admin.settings.payment_post')); ?>" id="live-class-settings-form">
                                ...
                                <div class="fpb-7">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('School Account Number')); ?></label>
                                    <input class="form-control eForm-control-file" id="formFileSm" type="text" name="account_number">
                                </div>
                                <div class="fpb-7">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Bank Name')); ?></label>
                                    <input class="form-control eForm-control-file" id="formFileSm" type="text" name="bank_name">
                                </div>
                                <div class="fpb-7">
                                    <label class="eForm-label" for="example-fileinput"><?php echo e(get_phrase('Account Name')); ?></label>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/payment_settings/key_settings.blade.php ENDPATH**/ ?>