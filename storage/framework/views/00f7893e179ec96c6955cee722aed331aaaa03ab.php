					        ...
					        <?php else: ?>
						        <div class="form-group">
					              <select name="status" id="status" class="form-select eForm-select eChoice-multiple-with-remove">
                                    ...
                                    <option value="pending"><?php echo e(get_phrase('pending')); ?></option>
					              </select>
					            </div>
					        <?php endif; ?>
				        </div>
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/parent/fee_manager/student_fee_manager.blade.php ENDPATH**/ ?>