             ...
             <div class="col-md-6 ms-auto">
               <div class="dashboard_report dashboard_upcoming_events">
                 ...
                 <div class="ds_report_list pt-38">
                   ...
                   <div class="text-end">
                     <a href="<?php echo e(route('accountant.events.list')); ?>" class="all_report_btn_2"><?php echo e(get_phrase('See all')); ?></a>
                   </div>
                 </div>
               </div>
             </div>
...
<?php echo $__env->make('accountant.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/accountant/dashboard.blade.php ENDPATH**/ ?>