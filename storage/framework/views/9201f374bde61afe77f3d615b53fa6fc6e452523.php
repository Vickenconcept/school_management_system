						...
						<div class="col-xl-5">
							<form class="" action="<?php echo e(route('superadmin.language.add')); ?>" method="post">
								...
								<div class="fpb-7">
									...
									<input type="text" id="language" required name="language" class="form-control eForm-control" placeholder="<?php echo e(get_phrase('No special character or space is allowed')); ?>">
									<p class="eCard-text">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/superadmin/language/manage_language.blade.php ENDPATH**/ ?>