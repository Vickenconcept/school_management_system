              ...
              <table class="table eTable eTable-2">
                ...
                <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="row">
                          <p class="row-number"><?php echo e($teachers->firstItem() + $key); ?></p>
                        </th>
                        <td>
                          <div
                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="largeModal('<?php echo e(route('admin.teacher.teacher_profile', ['id' => $teacher->id])); ?>','<?php echo e(get_phrase('Teacher Profile')); ?>')"><?php echo e(get_phrase('Profile')); ?></a>
                              </li>
                            </ul>
                          </div>
                        </td>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/teacher/teacher_list.blade.php ENDPATH**/ ?>