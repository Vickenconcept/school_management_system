                ...
                <div class="row">
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.parent.create')); ?>">
                                <?php echo csrf_field(); ?> 
                                ...
                                <div id="first_row">
                                    ...
                                    <div class="row p-0">
                                        ...
                                        <div class="col-xl-1 col-lg-1 col-md-2 col-sm-12 mb-3 mb-lg-0 pt-3">
                                            <label class="eForm-label"><?php echo e(get_phrase('')); ?></label>
                                ...
                                <div class="fpb-7 pt-2">
                                    <button type="submit" class="btn-form"><?php echo e(get_phrase('Add parent')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/parent/add_parent.blade.php ENDPATH**/ ?>