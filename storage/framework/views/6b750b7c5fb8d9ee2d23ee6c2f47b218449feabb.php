    ...
    <div class="user-profile-area d-flex flex-wrap">
        ...
        <div class="user-info d-flex flex-column">
            ...
            <div class="userContent text-center">
                ...
                <p class="info"><?php echo e(get_phrase('Accountant')); ?></p>
        ...
        <div class="user-details-info">
            ...
            >
                ...
                <form action="<?php echo e(route('accountant.profile.update')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('accountant.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/accountant/profile/view.blade.php ENDPATH**/ ?>