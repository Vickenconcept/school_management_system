	    ...
	    <div class="col-12">
	        ...
	        >
				<div class="d-flex flex-column">
					<h4><?php echo e(get_phrase('Student Fee Manager')); ?></h4>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap-2">
            <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.fee_manager.list')); ?>">
            	<div class="row">
                    <div class="row justify-content-md-center">
				        ...
				        <div class="col-xl-2 mb-3">
				        	<?php if(isset($selected_status) && $selected_status != ""): ?>
					            <div class="form-group">
					              <select name="status" id="status" class="form-select eForm-select eChoice-multiple-with-remove">
					                ...
					                <option value="unpaid" <?php echo e($selected_status == "unpaid" ?  'selected':''); ?>><?php echo e(get_phrase('Unpaid')); ?></option>
					              </select>
					            </div>
					        <?php else: ?>
						        <div class="form-group">
					              <select name="status" id="status" class="form-select eForm-select eChoice-multiple-with-remove">
					                <option value="all"><?php echo e(get_phrase('All status')); ?></option>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/student_fee_manager/student_fee_manager.blade.php ENDPATH**/ ?>