<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.librarian.create')); ?>">
        <?php echo csrf_field(); ?> 
        <div class="form-row">
            <div class="fpb-7">
            ...
            <div class="fpb-7">
                <label for="email" class="eForm-label"><?php echo e(get_phrase('Email')); ?></label><input type="email" class="form-control eForm-control" id="email" name = "email" required>
            </div>
...
</script><?php /**PATH C:\laragon\www\Ekattor8\resources\views/admin/librarian/add_librarian.blade.php ENDPATH**/ ?>